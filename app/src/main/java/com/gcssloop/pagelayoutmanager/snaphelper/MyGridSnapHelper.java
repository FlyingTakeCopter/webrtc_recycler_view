package com.gcssloop.pagelayoutmanager.snaphelper;
...
public class MyGridSnapHelper extends SnapHelper {
    @Nullable
     ...
     * @param column 列
     */
    public MyGridSnapHelper(int row, int column) {
        this.rowCount = row;
    ...
    protected LinearSmoothScroller createSnapScroller(LayoutManager layoutManager) {
        return !(layoutManager instanceof ScrollVectorProvider) ? null :
                new LinearSmoothScroller(this.recyclerView.getContext()) {
                    @Override
                    protected void onTargetFound(View targetView, State state, Action action) {
                        int[] snapDistances = MyGridSnapHelper.this.calculateDistanceToFinalSnap(MyGridSnapHelper.this.recyclerView.getLayoutManager(), targetView);
